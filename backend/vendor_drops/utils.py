...
# GUI-only deps — optional so the headless build runs without tkinter / ImageTk.
try:  # pragma: no cover
    import tkinter as tk  # type: ignore
    from PIL.ImageTk import PhotoImage  # type: ignore
    from PIL import Image as Image_module  # type: ignore
except Exception:  # noqa: BLE001
    tk = None  # type: ignore
    PhotoImage = None  # type: ignore
    Image_module = None  # type: ignore
