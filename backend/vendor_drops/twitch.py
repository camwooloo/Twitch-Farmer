...
from dxd_websocket import WebsocketPool
...
class Twitch:
    def __init__(self, settings: Settings):
        ...
        # SMARTBOX shares the same client-id as the points miner (rdavydov's TV
        # client) so a single Twitch login token works for both engines.
